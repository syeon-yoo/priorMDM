...
def change_to_smpl_params(input_path, cuda=True, device=0, hugs_smpl_betas_path=None):
    ...
    npy_path = os.path.join(os.path.dirname(input_path), 'priorMDM_results.npy')
    ...
    npy2obj = vis_utils.npy2obj(npy_path, sample_i, rep_i,
                                device=device, cuda=cuda, hugs_smpl_betas_path=hugs_smpl_betas_path)
